...
TODO:
move name + leg_title more to the left.
replace tree sprite with tree sprites
replace seed with seed sprite
...
Replace letter with letter sprite.
Add "love letter tree" when walking over the letter tree
Modify punch menu aspect with colors
Modify punch icon with punch sprite
Fix screen split opening, add curtains to left and right
Fix 
Make rgb fluctuations happen slower in character name
...
punch_menu_cells = #abd9ea
punch_menu_outline = #aee2f7
punch_menu_selected = #f1b404
punch_menu_selected_outer = #ffdd25


walk animation
(i need to cut the sprite of naked sprite, cutting feet off and hands)
https://www.youtube.com/shorts/jdeWFBvphog
https://www.youtube.com/watch?v=7g5Zc8w97YU

https://www.gtsetplanner.com